    ...
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        theme: ThemeData.light().copyWith(
            ...
            appBarTheme:
                AppBarTheme(brightness: Brightness.light, elevation: 1),
        ...
        darkTheme: ThemeData.dark().copyWith(
            ...
            colorScheme: ColorScheme.dark(
                onPrimary: Colors.white, surface: Colors.black),
            canvasColor: Colors.black,
            primaryTextTheme:
                GoogleFonts.latoTextTheme(ThemeData.dark().textTheme),
            accentTextTheme:
                GoogleFonts.latoTextTheme(ThemeData.dark().accentTextTheme),
