...
class ChatBloc extends ChangeNotifier {
  ...
  ChatBloc() {
    ...
    conversation = [
      Conversation(
          user: User('dangngocduc.bk@gmail.com', 'dangngocduc',
              'assets/sample/ic_avatar_1.jpg', 'Dang Ngoc Duc'),
          isActive: true,
          lastActive: DateTime.now()),
      Conversation(
          user: User('dangngocduc.bk@gmail.com', 'dangngocduc',
              'assets/sample/ic_avatar_1.jpg', 'Mola Mola'),
          isActive: true,
          lastActive: DateTime.now()),
      Conversation(
          user: User('dangngocduc.bk@gmail.com', 'dangngocduc',
              'assets/sample/ic_avatar_1.jpg', 'Hoang Anh'),
          isActive: true,
          lastActive: DateTime.now()),
      Conversation(
          user: User('dangngocduc.bk@gmail.com', 'dangngocduc',
              'assets/sample/ic_avatar_1.jpg', 'Pencil Academy'),
          isActive: true,
          lastActive: DateTime.now())
    ];
  }
